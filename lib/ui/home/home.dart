...
import 'package:my_music_app/ui/now_playing/playing.dart';
import 'package:my_music_app/ui/settings/settings.dart';
      ...
      leading: ClipRRect(
        ...
        child: FadeInImage.assetNetwork(
          ...
          imageErrorBuilder: (context, error, stackTrace) {
            return Image.asset('assets/images/itun.jpg', width: 48, height: 48);
          },
        ),
      ),
